 ...
 */
class CRM_Userpayment_Form_AddPayment extends CRM_Contribute_Form_AbstractEditPayment {

  const PAYMENTADD_REDIRECT_THANKYOU = 0;
  const PAYMENTADD_REDIRECT_URL = 1;
